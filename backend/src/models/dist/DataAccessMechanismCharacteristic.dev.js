...
var DataAccessMechanismCharacteristic =
/*#__PURE__*/
function (_Model) {
  _inherits(DataAccessMechanismCharacteristic, _Model);

  function DataAccessMechanismCharacteristic() {
    _classCallCheck(this, DataAccessMechanismCharacteristic);

    return _possibleConstructorReturn(this, _getPrototypeOf(DataAccessMechanismCharacteristic).apply(this, arguments));
  }

  return DataAccessMechanismCharacteristic;
}(Model);
